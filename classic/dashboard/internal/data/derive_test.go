...
func TestDeriveNoteFields(t *testing.T) {
	cases := []struct {
		...
		{
			name: "city + on-site keyword extracts location without state code",
			app: model.CareerApplication{
				Date:  "2026-04-06",
				Notes: "LLM pipelines + Miami on-site = strong fit",
			},
			location: "Miami",
			workMode: "Full",
			last:     "2026-04-06",
		...
		{
			name: "city + in-office keyword extracts location",
			app: model.CareerApplication{
				Date:  "2026-04-06",
				Notes: "Tier-1 brand; TSA forecasting is the hook; Austin in-office",
			},
			location: "Austin",
			workMode: "Full",
			last:     "2026-04-06",
		...
		{
			name: "international city + on-site extracts location",
			app: model.CareerApplication{
				Date:  "2026-04-06",
				Notes: "Acquired by Meta Dec 2025; Singapore on-site — confirm before applying",
			},
			location: "Singapore",
			workMode: "Full",
			last:     "2026-04-06",
		...
		{
			name: "abbreviated city + on-site extracts location",
			app: model.CareerApplication{
				Date:  "2026-04-07",
				Notes: "TSA forecasting beat Kalshi; perfect narrative fit. NYC on-site",
			},
			location: "NYC",
			workMode: "Full",
			last:     "2026-04-07",
