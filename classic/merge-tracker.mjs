...
const CANONICAL_STATES = ['Evaluated', 'Applied', 'Online Assessment', 'Responded', 'Interview', 'Offer', 'Rejected', 'Discarded', 'SKIP'];
...
function validateStatus(status) {
  ...
  const aliases = {
    ...
    'oa': 'Online Assessment', 'assessment': 'Online Assessment', 'online assessment': 'Online Assessment',
