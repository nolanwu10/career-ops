...
Defines the 9 canonical application states (`Evaluated`, `Applied`, `Online Assessment`, `Responded`, `Interview`, `Offer`, `Rejected`, `Discarded`, `SKIP`) with aliases for common variants. All pipeline scripts validate statuses against this file.
