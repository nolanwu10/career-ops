...
- **Classic architecture decisions** (`classic/CLAUDE.md`, scoring system, data contract) — maintainer only
...
4. **Understand the project** — read the root monorepo docs plus the relevant product documentation
